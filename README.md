...
- **Containers**: These containers will be deployed for running Strapi. We have two containers, one for Strapi and the other for Redis. We are setting the environment variables returned from the MariaDB Acorn service for the Strapi container.
